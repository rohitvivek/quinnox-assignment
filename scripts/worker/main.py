...
if __name__ == "__main__":
    ...
    sqs_client = boto3.client("sqs", endpoint_url=local_stack_endpoint, config=Config(region_name=local_stack_region),aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key)
